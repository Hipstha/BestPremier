			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="thumbnail">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore ipsam maiores esse cum quae voluptatibus dolores dolorem rem autem et temporibus quasi tempora asperiores sed molestiae error, id ipsum, doloremque?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet architecto culpa aliquam laudantium nobis recusandae excepturi, exercitationem quis esse perferendis est, dolores debitis. Doloremque neque similique veritatis repudiandae iure expedita?</p>
						<hr>
						<h2 class="text-center">Dudas</h2>
						<div class="fb-comments" data-href="http://localhost:8080/BestPremier/vista/Free/faqs.php?=FAQ1" data-width="1000" data-numposts="5"></div>
					</div>
				</div>

				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="thumbnail">
						<h1 class="text-center">¿Como funciona nuestra página?</h1>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore ipsam maiores esse cum quae voluptatibus dolores dolorem rem autem et temporibus quasi tempora asperiores sed molestiae error, id ipsum, doloremque?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet architecto culpa aliquam laudantium nobis recusandae excepturi, exercitationem quis esse perferendis est, dolores debitis. Doloremque neque similique veritatis repudiandae iure expedita?</p>
						<hr>
						<h2 class="text-center">Dudas</h2>
						<div class="fb-comments" data-href="http://localhost:8080/BestPremier/vista/Free/faqs.php?=FAQ2" data-width="1000" data-numposts="5"></div>
					</div>
				</div>

				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="thumbnail">
						<h1 class="text-center">¿Que ventajas tiene registrarse?</h1>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore ipsam maiores esse cum quae voluptatibus dolores dolorem rem autem et temporibus quasi tempora asperiores sed molestiae error, id ipsum, doloremque?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet architecto culpa aliquam laudantium nobis recusandae excepturi, exercitationem quis esse perferendis est, dolores debitis. Doloremque neque similique veritatis repudiandae iure expedita?</p>
						<hr>
						<h2 class="text-center">Dudas</h2>
						<div class="fb-comments" data-href="http://localhost:8080/BestPremier/vista/Free/faqs.php?=FAQ3" data-width="1000" data-numposts="5"></div>
					</div>
				</div>
